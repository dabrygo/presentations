...
% TODO Better example (doesn't handle multi-word last names)
%\begin{frame}[fragile]
%  \frametitle{Python Idioms: Unpacking}
%  \textbf{Python}
%  \inputminted{python}{last_name_first_name.py}
%
%  \textbf{Naive Java Implementation}
%  \begin{lstlisting}
%    String[] names = "John Ronald Reuel Tolkien".split(" ");
